...
<body>
	...
	<div class="jumbotron">
		<h1 class="display-4">Sign Up Request!</h1>
		<c:if test="${success}">
		<p class="lead">Your request has been successfully submitted.</p>
		</c:if>
		<c:if test="${not success}">
		<p class="lead">There was error processing your request. Please try again later.</p>
		</c:if>
		<a class="btn btn-primary btn-lg" href="/homepage" role="button">Home</a>
