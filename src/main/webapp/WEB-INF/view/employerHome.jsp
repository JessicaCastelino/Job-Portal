...
<body>
	...
	<button id="btnAddJob" data-toggle="modal" data-target="#modalpopup" class="buttonmargin btn btn-info"
		onclick="loadPrerequisiteCourse()">Add
		Job</button>
	<button id="btnAddJob" class="buttonmargin btn btn-info"
		onclick="window.location.href = window.location.origin + '/closedjobs'">View Closed Jobs</button>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div>
						<label class="col-sm-3">Job Title</label> <input type="text" id="txtjobtitle" /> <label
							class="col-sm-3">Location</label> <input type="text" id="txtLocation" />
					</div>
					<br>
					<div>
						<label class="col-sm-3">Open Positions</label> <input type="number" id="numOfOpenPosition" />
						<label class="col-sm-3">Job
							Type</label>
					...
					<div>
						<br> <label class="col-sm-3">Application deadline</label> <input type="text"
							id="applicationDeadline" /> <label class="col-sm-3">Job
							Description</label>
	...
	<script>
		...
		function clearFields() {
			$("input#txtjobtitle,input#txtLocation,input#numOfOpenPosition,input#selJobType,input#txtRateofPay,input#txtHoursperweek,input#applicationDeadline").val("");
			$("#txtJobDesc").val("");
		}
